...
import org.example.server.configuration.WebSocketConfig;
...
//FIKXhKoeMNzWSCLV
    ...
    void test(/*Session session*/) throws Exception {
        ...
        String requestBody = "{" +
                ...
                "\"prompt\": \"根据我传给你的天气，生成一幅类似书签的图片，精美且有意境，weather:阴，8摄氏度\"," +
                "\"imageType\": 1," +
    ...
    public void test1() throws Exception {
        ...
        String httpUri="/search/geo";
        String url="https://api-ai.vivo.com.cn"+httpUri;
        URIBuilder uriBuilder = new URIBuilder(url);
        uriBuilder.addParameter("keywords","卓悦汇");
        uriBuilder.addParameter("city","深圳市");
        ...
        nameValuePairs.add(new BasicNameValuePair("keywords","卓汇悦"));
        String encodedParams= URLEncodedUtils.format(nameValuePairs, "UTF-8");*/

        String canonicalQueryString1 = "city=%E6%B7%B1%E5%9C%B3%E5%B8%82&keywords=%E5%8D%93%E6%82%A6%E6%B1%87";
        String s = calculateSignature(httpMethod, httpUri, canonicalQueryString1, appId, epochSecond, string, appKey);
