...
public class AiUtil {
    ...
    public String getString(String message, String sessionId) throws Exception {
        ...
        String systemPrompt="你是一个专门用来为别人做规划的小贴士，我会提供给你今天我想要干的事情，请按照”好的，以下是您今天的学习计划&&day-hour到day-hour&&游览/参观/做（动词不限）xx地/xx事情“的格式回答以下问题，做出规划，并给出建议和注意事项，在每一条规划和建议前后加上“@@”，便于我对你的回答进行处理。严格按照格式来，一点错误都不能犯";
        ...
        if (response.getStatusLine().getStatusCode() == 200) {
            ...
            log.info("请求失败{}",response.getEntity().toString());
            return null;
    }
